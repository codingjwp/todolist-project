...
const SignInOfUp = ({ titles }: SignInOfUpProps) => {
  ...
  const [isEmail, isPassword, isDisable, changeEmailData, changePasswordData] =
    useValidation(titles);
